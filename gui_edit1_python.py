...
from live_support_python import Ui_Form
...
class Ui_MainWindow(object):
    ...
    def addTabs(self):
        ...
        if(have_child == 0 and self.treeWidget.currentItem() == self.treeWidget.topLevelItem(2)):
            ...
            tab.setObjectName("live_support_tab")

            horizontalLayout = QtWidgets.QHBoxLayout(tab)
            horizontalLayout.setContentsMargins(0, 0, 0, 0)
            horizontalLayout.setObjectName("horizontalLayout_2")

            verticalLayout = QtWidgets.QVBoxLayout()
            verticalLayout.setObjectName("verticalLayout")
            verticalLayout.setContentsMargins(60, -1, 60, -1)

            connectButton = QtWidgets.QPushButton(tab)
            connectButton.setObjectName("pushButton")
            connectButton.setText("Canlı Desteğe Bağlan")
            verticalLayout.addWidget(connectButton)
            horizontalLayout.addLayout(verticalLayout)

            self.tabWidget.addTab(tab, QtGui.QIcon('icons/live_support.png'), " Canlı Destek" )
